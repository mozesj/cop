    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Diary Book</h3>
          ...
          <div class="form-group col-md-6 col-sm-6">
           ...
           <label >Nationality</label>
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="" placeholder="Enter Phone Number">
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Enter Postal Address "></textarea>
                </div>
